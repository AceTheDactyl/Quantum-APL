...
SOLFEGGIO_PHOTONS = {
    396: SolfeggioPhoton(
        ...
        energy_j=2.888e-19,
        energy_ev=1.802,
        luminosity_v=0.0093,      # Interpolated from CIE 1931 table
        efficacy_lm_w=6.4,
        rgb_channel='R',
        name='Liberation',
        digit_root=9
    ...
    528: SolfeggioPhoton(
        ...
        energy_j=3.847e-19,
        energy_ev=2.401,
        luminosity_v=0.637,       # Interpolated from CIE 1931 table
        efficacy_lm_w=435.1,
        rgb_channel='G',
        name='Miracles',
        digit_root=6
    ...
    639: SolfeggioPhoton(
        ...
        energy_j=4.660e-19,
        energy_ev=2.908,
        luminosity_v=0.0088,      # Interpolated from CIE 1931 table
        efficacy_lm_w=6.0,
        rgb_channel='B',
        name='Connection',
        digit_root=9
